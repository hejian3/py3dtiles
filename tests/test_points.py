...
from py3dtiles.tilers.node.points_grid import Grid
from py3dtiles.tilers.pnts.pnts_management import compute_spacing
...
def node():
    ...
    return PntsNode(b'noeud', bbox, compute_spacing(bbox))
